...
# CODE QUALITY CHECKLIST SKILL CONTEXT

For this refer to the projects root directory and there will be a .agents/skills/code-review-expert folder. The is a `SKILL.md` from which this skill is to be inherited. 
Note: For any code refactoring or code review this skill is the primary context to be used for better coding standards.
