            ...
            <div className="shrink-0 px-6 py-5 border-b border-nx-outline-variant bg-white">
                <div className="flex items-center gap-3">
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-nx-outline-variant bg-nx-surface-container/60 hover:bg-nx-surface-container text-xs font-semibold text-nx-on-surface transition-colors shadow-sm"
                    >
                        📋 View My Pitches
                    </a>
                </div>
