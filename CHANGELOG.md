# [1.39.0](https://github.com/AnirudhAP2k/CorpConnect/compare/v1.38.0...v1.39.0) (2026-09-22)


### Features

* **api:** add participant mute proxy route to lv-service ([84f3d50](https://github.com/AnirudhAP2k/CorpConnect/commit/84f3d50af39fe3a7dbfaaf5fda639f07d67df047))
* **api:** add scoped WebSocket authentication token endpoint ([6f5c386](https://github.com/AnirudhAP2k/CorpConnect/commit/6f5c386b26bec897a176397818a2c9d1a8fdcaae))
* **api:** authorize virtual room host actions in room route ([d44c007](https://github.com/AnirudhAP2k/CorpConnect/commit/d44c007a93b7ae67adc9322fa5e9920f8c62981d))
* **api:** forward participant kick requests to lv-service ([b9ca33a](https://github.com/AnirudhAP2k/CorpConnect/commit/b9ca33ae966c5ce7148aaba35168c3947c0e26a9))
* **auth:** remove inline wsToken signing from session mapper ([78eb8b7](https://github.com/AnirudhAP2k/CorpConnect/commit/78eb8b757049c6f11ca0901cfb8fc02b959f33e0))
* **auth:** remove wsToken from session typings ([43d91e1](https://github.com/AnirudhAP2k/CorpConnect/commit/43d91e1c556420bfada2088f1c3c04b9ee8c19f4))
* **docs:** update documentation for virtual meetings and services ([ded2b4d](https://github.com/AnirudhAP2k/CorpConnect/commit/ded2b4da8493216b791ac963ff7ee8649b76df13))
* **docs:** update general tasks documentation ([29bf34e](https://github.com/AnirudhAP2k/CorpConnect/commit/29bf34e4eab168d388dedc148d06304cd914dda0))
* **docs:** update lv-service phase 11.9 task tracker ([083e45a](https://github.com/AnirudhAP2k/CorpConnect/commit/083e45aa4df44e7b793ec5ca5f30537347de97d8))
* **docs:** update lv-service v2 task tracker checklist ([a5bac03](https://github.com/AnirudhAP2k/CorpConnect/commit/a5bac03ad874f8ad2e2875a050d2f68276fafa53))
* **docs:** update v2 task checklist for live meeting ui ([aa37bb9](https://github.com/AnirudhAP2k/CorpConnect/commit/aa37bb9cd0b983dd928aacfcea05d3b65bdf43b4))
* **env:** add WS_SERVICE_AUTH_SECRET and LV_SERVICE_AUTH_SECRET to env example ([dcd0ab6](https://github.com/AnirudhAP2k/CorpConnect/commit/dcd0ab67938c8d8dc546bdc1304d2891eaa18f64))
* **events:** pass host status and user display name into VirtualRoom ([a2a56c3](https://github.com/AnirudhAP2k/CorpConnect/commit/a2a56c3d8c6a7ae2b18619286d18b202dc955e98))
* **events:** return isHost and displayName in virtual room join context ([fd15d9a](https://github.com/AnirudhAP2k/CorpConnect/commit/fd15d9a961633279da723e654ac56b37bb125ba9))
* **hooks:** fetch scoped ws token in useSocket ([d5a714d](https://github.com/AnirudhAP2k/CorpConnect/commit/d5a714d6d8d6b8b725a5e898bb62b9949f8289fa))
* **hooks:** implement useVirtualRoomSocket for reactions and raise hand ([e6e2eb8](https://github.com/AnirudhAP2k/CorpConnect/commit/e6e2eb87ed8b40dbdd7ed1ae2e2d83ab4dac5362))
* **hooks:** support ask-to-unmute event and host lower-hand in useVirtualRoomSocket ([314860d](https://github.com/AnirudhAP2k/CorpConnect/commit/314860d8126fa81aa71e5d4a8e5717e8aba4b8ef))
* **lv-service:** add mute track moderation route and host verification ([d9c6be6](https://github.com/AnirudhAP2k/CorpConnect/commit/d9c6be689ec845eaca576bb77563fa366991005b))
* **lv-service:** attach participant metadata and role to token payload ([24cb852](https://github.com/AnirudhAP2k/CorpConnect/commit/24cb852245b0c1e600911076d9e7cb5b7260d681))
* **lv-service:** bump version to 2.0.0 ([9f3f657](https://github.com/AnirudhAP2k/CorpConnect/commit/9f3f657b643cd5bcaa606c0620c9eff444fbcdc9))
* **lv-service:** refine internal auth token verification ([a0c1641](https://github.com/AnirudhAP2k/CorpConnect/commit/a0c1641d7d263053aa9a42dc0da0eb07026e265d))
* **lv-service:** support room admin grant and metadata in tokens ([dc17ccb](https://github.com/AnirudhAP2k/CorpConnect/commit/dc17ccbd865b1ab81fd642e95ad158d75742be6b))
* **lv-service:** update environment variables documentation ([6dcd87b](https://github.com/AnirudhAP2k/CorpConnect/commit/6dcd87b794b42b4bacda43fee155cabb64695519))
* **tests:** add test suite for scoped WebSocket token generation ([9cf544c](https://github.com/AnirudhAP2k/CorpConnect/commit/9cf544ce9ee609e48dad5313f45c37b6e1002566))
* **ui:** add raised hands queue and ask-to-unmute button in ParticipantList ([79dc801](https://github.com/AnirudhAP2k/CorpConnect/commit/79dc801c7ad40a4cfae3d40dbdb8ca1a2a0b16d0))
* **ui:** add VirtualRoomListSkeleton component ([e86500f](https://github.com/AnirudhAP2k/CorpConnect/commit/e86500f7890df2743257e03c0ea28eb46027ae80))
* **ui:** display contextual error screens with action buttons in VirtualRoom ([044ba7d](https://github.com/AnirudhAP2k/CorpConnect/commit/044ba7d2deed2b821b510e652f0f75f491c4ad78))
* **ui:** handle host ask-to-unmute requests with actionable toast ([b9ddbe6](https://github.com/AnirudhAP2k/CorpConnect/commit/b9ddbe67c743eecfe39450a4fa55913f56da21da))
* **ui:** implement custom branded MeetingChat component ([f23556a](https://github.com/AnirudhAP2k/CorpConnect/commit/f23556af4d97682ef1e20155a1597eac005f795f))
* **ui:** implement custom branded MeetingLayout shell ([c5f61ad](https://github.com/AnirudhAP2k/CorpConnect/commit/c5f61ad369b185f330d378d67eb756870aa14f89))
* **ui:** implement MeetingControls with host actions and hand raise ([83b8593](https://github.com/AnirudhAP2k/CorpConnect/commit/83b859388ac2e31283a23da304f4364dc4541fcc))
* **ui:** implement ParticipantList with moderation actions ([5052520](https://github.com/AnirudhAP2k/CorpConnect/commit/5052520e269da6ed0d5e95f94169dbc502e309e3))
* **ui:** implement ReactionsOverlay for live floating emojis ([add5c57](https://github.com/AnirudhAP2k/CorpConnect/commit/add5c57a27f8e594a60f4cb01f46eb344100095d))
* **ui:** integrate MeetingLayout into VirtualRoom ([e7f716a](https://github.com/AnirudhAP2k/CorpConnect/commit/e7f716a29723b379ab326e24b54cde57365f380f))
* **ui:** replace alert with sonner toast on meeting end error ([4e7cb73](https://github.com/AnirudhAP2k/CorpConnect/commit/4e7cb7325cb7f25aa8ec34d2f18c33f0ae656fa7))
* **ui:** support skeleton loading in VirtualRoomList ([65abae2](https://github.com/AnirudhAP2k/CorpConnect/commit/65abae2ce984154bc583bb4dbd33fdf9c8e7f6a4))
* **virtual:** use LV_SERVICE_AUTH_SECRET for lv-service client requests ([bf4ec3a](https://github.com/AnirudhAP2k/CorpConnect/commit/bf4ec3a89c1d147c7317681ec7c47b380349ce6b))
* **ws-service:** add ask-to-unmute event handler and host verification for lower-hand ([1ba2123](https://github.com/AnirudhAP2k/CorpConnect/commit/1ba21230b9974bc66c18813dd05d1ad0c5cb7ad9))
* **ws-service:** add audience and issuer validation for socket auth ([d575590](https://github.com/AnirudhAP2k/CorpConnect/commit/d575590eb0fcd8c9877c7587d866ba1d63a7022b))
* **ws-service:** bump version to 1.1.0 ([6639b1c](https://github.com/AnirudhAP2k/CorpConnect/commit/6639b1ceb85758a5c8d3102a2c67ad37a9d3cdfe))
* **ws-service:** document WS_SERVICE_AUTH_SECRET environment variable ([df9eb3b](https://github.com/AnirudhAP2k/CorpConnect/commit/df9eb3ba8ef81c04ad28e5934d428f89c65eed12))
...
* **ai:** update AI chat widget with dark theme tokens ([64d3a20](https://github.com/AnirudhAP2k/CorpConnect/commit/64d3a205e38aa27a6ff624e6a9bbc48b8e05ad39))
* **ai:** update AI service client formatting and endpoint configuration ([99398c4](https://github.com/AnirudhAP2k/CorpConnect/commit/99398c48e674da9e19e383e6ed397cf39b4ad45d))
* **ai:** update AI writer button with dark mode styling ([cf4c6bf](https://github.com/AnirudhAP2k/CorpConnect/commit/cf4c6bf440575d5c1746f6823578625355f88066))
* **app:** update root layout theme provider configuration ([e0375a6](https://github.com/AnirudhAP2k/CorpConnect/commit/e0375a6ac3acc131452dce6590c91eb43b0d7d54))
* **billing:** update provider picker modal dark theme styling ([b1bbc2e](https://github.com/AnirudhAP2k/CorpConnect/commit/b1bbc2ee85cd2ef5b636d13a109faaa8bba81711))
* **dashboard:** update dark mode theme styling in dashboard page ([c3e41ec](https://github.com/AnirudhAP2k/CorpConnect/commit/c3e41ec11a99a607be55dd9237bea0998f21d324))
* **dashboard:** update event row component dark mode styles ([3f49806](https://github.com/AnirudhAP2k/CorpConnect/commit/3f4980605de56c4acef947e3ed2584a0ccb52763))
* **dashboard:** update stat card component dark mode styles ([ce75de1](https://github.com/AnirudhAP2k/CorpConnect/commit/ce75de15cdbc64ec01df8f152e36f93cb6bc93ea))
* **events:** update dark mode styles on event edit page ([996217b](https://github.com/AnirudhAP2k/CorpConnect/commit/996217b29b02a50a0252cb9004d025fc9c53dc8f))
* **events:** update event creation page styling for dark mode ([25fd7b3](https://github.com/AnirudhAP2k/CorpConnect/commit/25fd7b333f6bbad7c12d9ff5af0cadb2438b5d7a))
* **events:** update event detail page with dark mode tokens ([b178e46](https://github.com/AnirudhAP2k/CorpConnect/commit/b178e46654b1ae1a2732f60676f790ba1e4d05ce))
* **events:** update events page dark mode theme variables ([1fae6a4](https://github.com/AnirudhAP2k/CorpConnect/commit/1fae6a41a0e45cfd0a8c881033b60556fb40f332))
* **events:** update invite guests modal dark mode styles ([2882265](https://github.com/AnirudhAP2k/CorpConnect/commit/288226593683c3643257e44968856b56794e9d2b))
* **events:** update meeting request button theme styling ([2ee0fc6](https://github.com/AnirudhAP2k/CorpConnect/commit/2ee0fc685e2892c2bfa04cfef9d6e910de50da1d))
* **events:** update meeting requests panel dark mode styles ([d45f002](https://github.com/AnirudhAP2k/CorpConnect/commit/d45f00288ad59deef9412c76ed9f02607a32064b))
* **events:** update organization match widget theme styling ([e3a4232](https://github.com/AnirudhAP2k/CorpConnect/commit/e3a423259432735aec29334067c8f052c0c174d3))
* **events:** update payment success page with dark theme styles ([9cc9f9c](https://github.com/AnirudhAP2k/CorpConnect/commit/9cc9f9c16e4bba4241600c2891595176b835a9e5))
* **feedback:** update feedback button dark mode styling ([c9d7c0b](https://github.com/AnirudhAP2k/CorpConnect/commit/c9d7c0bb8eb0eebf3ecd6af0e1f6194201c01183))
* **feedback:** update feedback form dark mode styles ([ca79417](https://github.com/AnirudhAP2k/CorpConnect/commit/ca79417a8c08bf3f88a3732346820bb6bc60be37))
* **messaging:** fix MessagingShell JSX opening wrapper in layout ([01547ae](https://github.com/AnirudhAP2k/CorpConnect/commit/01547aea9040ab08bb1c00eab73e4f50c9db258a))
* **messaging:** update chat window with dark mode classes ([21de1c6](https://github.com/AnirudhAP2k/CorpConnect/commit/21de1c606ce0f91e4109a5dd9008cac4d9a3239c))
* **messaging:** update conversation item dark mode styles ([0faf806](https://github.com/AnirudhAP2k/CorpConnect/commit/0faf806b68abb2b684a60e039cb6c27144266abd))
* **messaging:** update conversation list dark mode styles ([00669cd](https://github.com/AnirudhAP2k/CorpConnect/commit/00669cdbb0c8da90baae6a17cd470cc7d22b4b79))
* **messaging:** update group chat window with dark mode styles ([dc6da8e](https://github.com/AnirudhAP2k/CorpConnect/commit/dc6da8e5f3925c42012a0cd19e1397f4a27c3dfa))
* **messaging:** update group conversation list theme styles ([0d11cf0](https://github.com/AnirudhAP2k/CorpConnect/commit/0d11cf02b440151de2369a1077bb21b169d38a60))
* **messaging:** update group members panel dark mode styles ([4a208fd](https://github.com/AnirudhAP2k/CorpConnect/commit/4a208fd21db3641ce9881495993dc18a691fa205))
* **messaging:** update group message bubble dark theme styles ([866663d](https://github.com/AnirudhAP2k/CorpConnect/commit/866663ddbd4ed6c1a1004b341173a6068d65927e))
* **messaging:** update message bubble dark theme styles ([57ecc5b](https://github.com/AnirudhAP2k/CorpConnect/commit/57ecc5bd1c8ad091ded55fca6e8544a94f9b8492))
* **messaging:** update message input component theme styles ([4d26a38](https://github.com/AnirudhAP2k/CorpConnect/commit/4d26a387c0c5f613a59e076fc9cd1ffc9c03afae))
* **messaging:** update messaging layout with dark theme classes ([59d8682](https://github.com/AnirudhAP2k/CorpConnect/commit/59d8682b38d1908ee4aec1cf2453ea689cd1353c))
* **messaging:** update messaging skeletons dark mode styles ([46f3b3f](https://github.com/AnirudhAP2k/CorpConnect/commit/46f3b3f04bf82215c29dad3bc552eb2421fc23d5))
* **middleware:** update middleware session and theme route handling ([7fff42b](https://github.com/AnirudhAP2k/CorpConnect/commit/7fff42b0efcce7520a950fa4d69657245777e15f))
* **onboarding:** update onboarding page with dark mode tokens ([bb18e21](https://github.com/AnirudhAP2k/CorpConnect/commit/bb18e21202269f80097cbb178511ca4c296a5443))
* **organizations:** update connect button dark theme styles ([f43e3c3](https://github.com/AnirudhAP2k/CorpConnect/commit/f43e3c3a6cdfec68a4b49b9835a2c17d33c2bfed))
* **organizations:** update organization card dark mode styles ([2c3eeac](https://github.com/AnirudhAP2k/CorpConnect/commit/2c3eeac556260dc34ad9f537b8e3e0028fd25558))
* **organizations:** update organization detail page with dark mode styles ([d44f571](https://github.com/AnirudhAP2k/CorpConnect/commit/d44f57144d130470da252d862abd4b2da8fbce05))
* **organizations:** update organization discover filters styling ([7a94593](https://github.com/AnirudhAP2k/CorpConnect/commit/7a94593312537de54a81ae0e3ffc098445cbc135))
* **organizations:** update organization discover page dark theme styles ([2cac9a9](https://github.com/AnirudhAP2k/CorpConnect/commit/2cac9a9c652917322cb660c98c4fa848414778e7))
* **ui:** remove duplicate className attributes in OrganizationForm ([a9d3ad6](https://github.com/AnirudhAP2k/CorpConnect/commit/a9d3ad6b2b00639c14639a58e91b092f2400e3d1))
* **ui:** update date range filter with dark mode variables ([36572d1](https://github.com/AnirudhAP2k/CorpConnect/commit/36572d131e58cdcc28128b0f22c37d153c09b879))
* **ui:** update dropdown component dark mode styles ([841f805](https://github.com/AnirudhAP2k/CorpConnect/commit/841f805ed7eb67304e67837a750bfe8c29855b3a))
* **ui:** update event card component theme styles ([03764d2](https://github.com/AnirudhAP2k/CorpConnect/commit/03764d2c70752b5b4aa31822c0453322bb971e22))
* **ui:** update event participants panel theme styles ([068deec](https://github.com/AnirudhAP2k/CorpConnect/commit/068deec706a53f4e191f3841569ef169b21c059c))
* **ui:** update events form with dark mode theme styling ([a525081](https://github.com/AnirudhAP2k/CorpConnect/commit/a52508184a7fcce59b74b6694089a1b6cb8ef2f8))
* **ui:** update file uploader component dark theme styles ([ed6effe](https://github.com/AnirudhAP2k/CorpConnect/commit/ed6effedb5bb031b5b74fb8a07a8ab8ca49f46ce))
* **ui:** update footer component dark mode styling ([1fce3c0](https://github.com/AnirudhAP2k/CorpConnect/commit/1fce3c045485ae82f524f35f0aec55679d95982e))
* **ui:** update member card component theme styles ([28f64b1](https://github.com/AnirudhAP2k/CorpConnect/commit/28f64b1adc3fbc2bf4d549c6c83159cf8e41ea62))
* **ui:** update mobile sidebar navigation styling ([69929a8](https://github.com/AnirudhAP2k/CorpConnect/commit/69929a8003f94b150cec4081ab0e574f42f615fe))
* **ui:** update notification bell component styling ([870c649](https://github.com/AnirudhAP2k/CorpConnect/commit/870c6491f16bede6fd8689b167ae200aecdbc093))
* **ui:** update organization card skeleton dark mode styles ([2d4f6a7](https://github.com/AnirudhAP2k/CorpConnect/commit/2d4f6a7dad76b05dab49883b1cf4f4d7b976513d))
* **ui:** update organization form with dark mode styling ([03edcea](https://github.com/AnirudhAP2k/CorpConnect/commit/03edceabb6a6d1d35daf4081267376f6aae4ad40))
* **ui:** update organization switcher styling for dark mode ([15cafbc](https://github.com/AnirudhAP2k/CorpConnect/commit/15cafbc28ecd1be87ee04fe0cb1708912ad9c2e8))
* **ui:** update sidebar navigation dark mode styling ([546d291](https://github.com/AnirudhAP2k/CorpConnect/commit/546d291fb725a3406f9ec0edf48962307552266a))
* **ui:** update tag array input component styling ([a1f429b](https://github.com/AnirudhAP2k/CorpConnect/commit/a1f429b6f79431b267cb0e3fa581119295f28621))
* **ui:** update theme toggle component design ([df7da80](https://github.com/AnirudhAP2k/CorpConnect/commit/df7da804f54cd6b20791f1a37694042cee7e1bd9))
* **ui:** update top header with theme switcher and dark mode styles ([26136a2](https://github.com/AnirudhAP2k/CorpConnect/commit/26136a201630084cc9b17635976b61435d52fc55))
* **ui:** update verification reminder banner styling ([6123320](https://github.com/AnirudhAP2k/CorpConnect/commit/6123320a68c779fcdddc34a1ac8f98ea1e223df1))
* **ui:** use roleBadgeStyle in MemberCard badge component ([9313a68](https://github.com/AnirudhAP2k/CorpConnect/commit/9313a68371278204dee84e9363845f94f9c4d1f0))
* **virtual:** update join virtual button dark mode styles ([9b4afe5](https://github.com/AnirudhAP2k/CorpConnect/commit/9b4afe51178e4eb1da4bb4c8c03121edd3d56837))
* **virtual:** update virtual room list dark mode styles ([5b330bd](https://github.com/AnirudhAP2k/CorpConnect/commit/5b330bdbdedfbf1d8f72d55c3f4508e90fcb8a8c))


### Features

* **docs:** update design changes documentation ([7580d6e](https://github.com/AnirudhAP2k/CorpConnect/commit/7580d6ebc75f93e4facde44c76141d6c95f4cf7d))
* **docs:** update go to market plan documentation ([9c9f7cd](https://github.com/AnirudhAP2k/CorpConnect/commit/9c9f7cd355ec4bb8cea1c54605af10f26779a01e))
...
* **admin:** format and clean up admin actions ([befa1fb](https://github.com/AnirudhAP2k/CorpConnect/commit/befa1fb320fd5e7ba7ae6774cae9987bc9a660d3))
* **api:** use event currency when creating checkout sessions ([ff0be8d](https://github.com/AnirudhAP2k/CorpConnect/commit/ff0be8d985e2299eedef2e25145a4ffdd7e4514e))
* **auth:** format logout action handler ([6ef7e5d](https://github.com/AnirudhAP2k/CorpConnect/commit/6ef7e5d17503dd85ffb345f39e7e0e338bb7242c))
* **billing:** format and clean up Stripe gateway adapter ([b08216f](https://github.com/AnirudhAP2k/CorpConnect/commit/b08216fca0029d2ab88b23c84ffcd2c0c710c063))
* **billing:** format and refine billing domain queries ([086e848](https://github.com/AnirudhAP2k/CorpConnect/commit/086e84832deadebea39128f6b78f260c5f2031bf))
* **billing:** format and refine billing gateway types ([0ce8e18](https://github.com/AnirudhAP2k/CorpConnect/commit/0ce8e188e4d7f59efe40d268fde9d6c20b28481d))
* **billing:** format and refine pricing configuration helpers ([47b7e0b](https://github.com/AnirudhAP2k/CorpConnect/commit/47b7e0bc98a26797578a1dfad1b2daf4422efc87))
* **billing:** format PricingPlans component ([3649b4f](https://github.com/AnirudhAP2k/CorpConnect/commit/3649b4fcdc7a342f66a931f3ab401b910540830c))
* **billing:** format ProviderPicker component ([6bdd53e](https://github.com/AnirudhAP2k/CorpConnect/commit/6bdd53ed80c0cffcd8ce38a5fe11f5c41649ae0b))
* **billing:** re-export BillingStatus from types module ([34b7221](https://github.com/AnirudhAP2k/CorpConnect/commit/34b722192a174b69f72c6780d93bfdeb42350ffb))
* **billing:** strongly type SubscriptionManage props and format code ([70d1087](https://github.com/AnirudhAP2k/CorpConnect/commit/70d1087a7fc3555e97f6e2f4304c927fb09d8688))
* **billing:** update getBillingStatus return types and format service ([77dfa93](https://github.com/AnirudhAP2k/CorpConnect/commit/77dfa93c0032e9da5405816fc0fa0404f517674e))
* **crypto:** format and standardize token hashing helpers ([83ceb73](https://github.com/AnirudhAP2k/CorpConnect/commit/83ceb737d58d99a7113f3d1f12cdbccd5398fa58))
* **dashboard:** format revenue widget with organization currency ([a17f380](https://github.com/AnirudhAP2k/CorpConnect/commit/a17f380309ac2fe9942b9d1a019d611e20c3e52d))
* **events:** display event ticket price with currency formatting ([89742df](https://github.com/AnirudhAP2k/CorpConnect/commit/89742dfe4f54a1d9cd1c48edb613a4e257080e6a))
* **file-uploads:** evaluate ClamAV environment variables dynamically ([9ec10c3](https://github.com/AnirudhAP2k/CorpConnect/commit/9ec10c35895e5290a04b2e9f91e408a638cd6fe2))
* **file-uploads:** standardize formatting and interfaces for upload types ([d3dc312](https://github.com/AnirudhAP2k/CorpConnect/commit/d3dc3129ca0e563ee5dd70b90d480fdde2d2c459))
* **mailer:** format and clean up email sending helper ([93c7939](https://github.com/AnirudhAP2k/CorpConnect/commit/93c7939a0106d993bcd94b84ed40962d40a2f295))
* **money:** format money formatting helper functions ([120a2cd](https://github.com/AnirudhAP2k/CorpConnect/commit/120a2cdbe0e5e0d2b9e5c0512ff596e960d6e377))
* **payment:** deprecate static price IDs in favor of pricing domain ([df8f5cc](https://github.com/AnirudhAP2k/CorpConnect/commit/df8f5cc6900db2db499746a1acaad7b3bff51ff5))
* **payment:** deprecate static price IDs in favor of pricing domain ([5dc4b80](https://github.com/AnirudhAP2k/CorpConnect/commit/5dc4b80768f576cc4d11f73cade407c68a4f5390))
* **tests:** add currency assertions to event checkout tests ([f7e9cf9](https://github.com/AnirudhAP2k/CorpConnect/commit/f7e9cf9d0fa39393e0aadd751e1f7cf03e70a481))
* **tests:** update billing gateway test fixtures for currency support ([931a98f](https://github.com/AnirudhAP2k/CorpConnect/commit/931a98ffbf879dc9e055662ddddbfc8aa47bec49))
* **tests:** update billing subscribe tests with currency payload ([e9ba2a3](https://github.com/AnirudhAP2k/CorpConnect/commit/e9ba2a337a58fd10349689a354442c456a87271f))
* **utils:** format price using currency aware money utility ([bddf900](https://github.com/AnirudhAP2k/CorpConnect/commit/bddf900e5d250cc2bfc435cc991fe3108c69155e))
* **vscode:** add workspace settings for code formatting ([90ab2c2](https://github.com/AnirudhAP2k/CorpConnect/commit/90ab2c29ad32bde0d27b07978cadb86d17760a0c))


### Features

* **api:** add currency and billing interval support to subscribe route ([2e0d6c1](https://github.com/AnirudhAP2k/CorpConnect/commit/2e0d6c1e9827ec72bc04a29fa3ddeed06de409a6))
* **api:** add endpoint for updating organization preferred currency ([cd83a04](https://github.com/AnirudhAP2k/CorpConnect/commit/cd83a0427f9284e90e84f571ec3d34f5a1f24b60))
* **api:** add route to handle subscription cancellation ([6227045](https://github.com/AnirudhAP2k/CorpConnect/commit/622704518dfa1bcc50350f6539cd498aa671a640))
* **api:** expose organization preferred currency in meta endpoint ([fc8ad74](https://github.com/AnirudhAP2k/CorpConnect/commit/fc8ad74be724fc56a4b8cc615e7bd5973e04fd1a))
* **billing:** add currency and billing interval selectors to provider picker ([7f9e5a0](https://github.com/AnirudhAP2k/CorpConnect/commit/7f9e5a0b257c0f36ef168bf6e3cc9542abb2dfbc))
* **billing:** add currency and interval to subscription options ([dd1f5be](https://github.com/AnirudhAP2k/CorpConnect/commit/dd1f5beaff9f6d2ddd7eda1ce12995134b34afd9))
* **billing:** add domain billing types and plan configurations ([2582395](https://github.com/AnirudhAP2k/CorpConnect/commit/2582395546acc92b5edad74772ae13a24755fc7b))
* **billing:** add localized pricing matrix and currency resolver ([dab197e](https://github.com/AnirudhAP2k/CorpConnect/commit/dab197e685e1305190d375f038c3696a02a91876))
* **billing:** add money and currency conversion utilities ([49bcc9d](https://github.com/AnirudhAP2k/CorpConnect/commit/49bcc9de55af8792397f843fd92c845ae4259194))
* **billing:** add multi-currency plan catalog definition ([c5c7e1d](https://github.com/AnirudhAP2k/CorpConnect/commit/c5c7e1d069fdb3b94c1db24e7dcc271bc18a5e17))
* **billing:** add public pricing view with currency toggle ([3e666c8](https://github.com/AnirudhAP2k/CorpConnect/commit/3e666c84d438db03a0252d201622991aa216e711))
* **billing:** add subscription management UI component ([2d36eab](https://github.com/AnirudhAP2k/CorpConnect/commit/2d36eabfbd0581f4af22456fe2d4cd546f685a37))
* **billing:** export organization preferred currency in billing query ([f14aa0d](https://github.com/AnirudhAP2k/CorpConnect/commit/f14aa0d968d463891213ae26527074fb352bba75))
* **billing:** export pricing utilities and currency resolvers ([5e0ce45](https://github.com/AnirudhAP2k/CorpConnect/commit/5e0ce450c93cf01544f6dd674cbba992f23746a3))
* **billing:** render multi-currency pricing plans with interval toggle ([d94ab0b](https://github.com/AnirudhAP2k/CorpConnect/commit/d94ab0b5e147432796c794fcf8db8aa307e1d2f5))
* **billing:** support currency switching and multi-currency billing service ([1c2514a](https://github.com/AnirudhAP2k/CorpConnect/commit/1c2514a290979097b4f20387fe9d5262724616ad))
* **billing:** support localized prices in stripe checkout adapter ([4698421](https://github.com/AnirudhAP2k/CorpConnect/commit/4698421eb68b86d3fd14b70337a6c029f5d12b5a))
* **billing:** support multi-currency plan IDs in razorpay adapter ([a2cc3ad](https://github.com/AnirudhAP2k/CorpConnect/commit/a2cc3ad861bd615fd11b0a24953ee16c47cec6c5))
* **billing:** update billing page with multi-currency plans and management ([1d29159](https://github.com/AnirudhAP2k/CorpConnect/commit/1d29159e89707cbc50904c1ce415718b31dd6f1d))
* **dashboard:** pass preferred currency to organization revenue widget ([5f165f6](https://github.com/AnirudhAP2k/CorpConnect/commit/5f165f6cf85594732fdb7a517a5f93d8b502cda9))
* **env:** add multi-currency razorpay and stripe price env vars ([8aa6c22](https://github.com/AnirudhAP2k/CorpConnect/commit/8aa6c226fad2b0346763d429d468be774f0fab5f))
* **events:** add currency selection field to event creation form ([6d291aa](https://github.com/AnirudhAP2k/CorpConnect/commit/6d291aa085fa84869926e3d35a0c81fcf4a1cc7f))
* **events:** pass currency options in event create page ([2ec86f5](https://github.com/AnirudhAP2k/CorpConnect/commit/2ec86f57e3028c93fce5baa9031e3182726c062c))
* **events:** support currency field in event create schema ([40ee4e2](https://github.com/AnirudhAP2k/CorpConnect/commit/40ee4e2f3172d051cd641f8725ddc68f708c7d7f))
* **marketing:** update pricing strategy and currency jurisdiction in go to market plan ([39293f3](https://github.com/AnirudhAP2k/CorpConnect/commit/39293f352afcebfb668d9644782d1213d426fa80))
* **organizations:** set preferred currency on organization creation ([e8781c9](https://github.com/AnirudhAP2k/CorpConnect/commit/e8781c94281ccad2766928025f468705bc2b0bb2))
* **pricing:** integrate public pricing component on pricing page ([850d4c6](https://github.com/AnirudhAP2k/CorpConnect/commit/850d4c610747a25d794093884a819bbc4d7dc3a6))
* **tests:** add test cases for multi-currency billing service ([6247c5d](https://github.com/AnirudhAP2k/CorpConnect/commit/6247c5d49bd69db4227429a7314f28acac981b5a))
* **tests:** add tests for localized plan pricing and currency resolution ([e226c47](https://github.com/AnirudhAP2k/CorpConnect/commit/e226c4745ab22dcf31a6d7eb355096a6fd0a815f))
* **users:** select organization preferred currency in primary org query ([9b6f13c](https://github.com/AnirudhAP2k/CorpConnect/commit/9b6f13cd7fcd1d873a1bf99b262982c19c6aa9bd))
* **validation:** add currency validation to event base schema ([b619d49](https://github.com/AnirudhAP2k/CorpConnect/commit/b619d492f7407b98fc66206015478c691d1753cd))
